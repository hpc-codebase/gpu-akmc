...
bool PKMC::prepare() {
  ...
  //kiwi::logs::v(" ", " 11111111111111111111111111111111   .\n");
  sim->createDomain(config_v.box_size, config_v.lattice_const, config_v.cutoff_radius);
  //kiwi::logs::v(" ", " 22222222222222222222222222222222   .\n");
  // std::cout << " 11111111111111111 " << std::endl;
  sim->createLattice();
  //kiwi::logs::v(" ", " 33333333333333333333333333333333  .\n");
